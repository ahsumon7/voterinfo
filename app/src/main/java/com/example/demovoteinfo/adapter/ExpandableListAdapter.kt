package com.example.demovoteinfo.adapter

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import android.widget.TextView // Or your actual view types
import androidx.recyclerview.widget.RecyclerView
import com.example.demovoteinfo.R // If you use layout resources
...
sealed class DisplayableItem {
    ...
    data class VotingCenterItem(val votingCenter: VotingCenter, val areaGroupName: String) : DisplayableItem()
}
...
class ExpandableListAdapter(
    ...
    private val expandedStates: MutableMap<String, Boolean> = mutableMapOf() // To store expanded state of groups
